...
html = f"""<!DOCTYPE html>
<head>
    <title>.net framework 运行库列表（来自 Wine 运行器）</title>
...
lists = requests.get("https://code.gitlink.org.cn/gfdgd_xi/wine-runner-list/raw/branch/master/net/list.json").json()
for i in lists:
